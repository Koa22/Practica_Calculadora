...
function binaria(){
  ...
  let bina = decimal.toString(2);

  pantalla.innerHTML=bina;
...
function seno(){
  ...
  var sen=Math.sin(x*Math.PI/180);//Te los da en grados

  pantalla.innerHTML=sen;
}

function coseno(){

  var cos=Math.cos(x*Math.PI/180);//Te los da en grados

  pantalla.innerHTML=cos;
}


function tangente(){

  var tan=Math.tan(x*Math.PI/180);//Te los da en grados

  pantalla.innerHTML=tan;
}
